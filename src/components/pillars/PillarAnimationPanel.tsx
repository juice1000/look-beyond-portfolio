...
const PillarAnimationPanel = ({ kind, isDarkMode }: PillarAnimationPanelProps) => {
  return (
    <div
      className="relative aspect-[1100/760] min-h-[22rem] w-full overflow-hidden sm:min-h-[28rem] lg:min-h-0"
      style={{
        background: isDarkMode ? "#04060f" : "rgba(255,255,255,0.35)",
        border: isDarkMode ? "1px solid #0f1e35" : "1px solid rgba(255,255,255,0.6)",
        boxShadow: isDarkMode ? "0 24px 80px rgba(0,0,0,0.22)" : "0 8px 32px rgba(0,0,0,0.06)",
      }}
    >
